...
| SF-034 | decision-evidence-ledger | development | `development/decision-evidence-ledger/SKILL.md` | forged | 3/3 | fixed typing, contradiction links, provenance, consumers, revisit triggers, per-item owners, temporal supersession, and write-safety pressure | `agent-state/skill-forge-runs/decision-evidence-ledger.md` | complete |
| SF-035 | runtime-path-forensics | development | `development/runtime-path-forensics/SKILL.md` | forged | 3/3 | stable record and hop IDs, typed edges, interval timelines, per-record strength, per-hop alternatives, and operator-ready discriminators | `agent-state/skill-forge-runs/runtime-path-forensics.md` | complete |
| SF-036 | handoff-recovery | development | `development/handoff-recovery/SKILL.md` | forged | 3/3 | task-to-worktree binding, exact commands/cwds, typed recovery closure, input identity, custody promotion, and bounded sensitive-history reads | `agent-state/skill-forge-runs/handoff-recovery.md` | complete |
| SF-037 | subsystem-explanation | development | `development/subsystem-explanation/SKILL.md` | forged | 3/3 | prose-only claims, invented diagram edges, conditional selection, proof dimensions, identity encoding, and boundary-capable contradiction resolution | `agent-state/skill-forge-runs/subsystem-explanation.md` | complete |
| SF-038 | visual-parity-proof | development | `development/visual-parity-proof/SKILL.md` | forged | 3/3 | mismatched conditions, missing required surfaces, invalid masks, aggregate-score concealment, and critical-region drift | `agent-state/skill-forge-runs/visual-parity-proof.md` | complete |
| SF-039 | diagram-atlas | systems-design | `systems-design/diagram-atlas/SKILL.md` | pending-red | 0/3 | drop-in skill pressure | - | RED scenario |
