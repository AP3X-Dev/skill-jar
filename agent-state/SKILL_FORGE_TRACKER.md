...
| SF-003 | autonomous-advisor | development | `development/autonomous-advisor/SKILL.md` | red-captured | 0/3 | hands-off PRP guardrail pressure | `agent-state/skill-forge-runs/autonomous-advisor.md` | GREEN patch captured rationalizations |
