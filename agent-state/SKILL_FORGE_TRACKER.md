...
| SF-004 | bug-pipeline | development | `development/bug-pipeline/SKILL.md` | refactor-clean-1 | 1/3 | hunter/fixer/validator shortcut pressure | `agent-state/skill-forge-runs/bug-pipeline.md` | REFACTOR judge run 2 |
