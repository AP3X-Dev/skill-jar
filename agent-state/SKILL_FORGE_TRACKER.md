...
| SF-002 | auto-research | development | `development/auto-research/SKILL.md` | refactor-clean-2 | 2/3 | fixed-budget experiment shortcut pressure | `agent-state/skill-forge-runs/auto-research.md` | REFACTOR judge run 3 after baseline-waiver patch |
