...
| SF-003 | autonomous-advisor | development | `development/autonomous-advisor/SKILL.md` | refactor-clean-2 | 2/3 | hands-off PRP guardrail pressure | `agent-state/skill-forge-runs/autonomous-advisor.md` | REFACTOR judge run 3 |
