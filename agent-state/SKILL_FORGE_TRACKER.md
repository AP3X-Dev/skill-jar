...
|----|-------|----------|------|--------|------------|----------------|---------------|-------------|
| SF-001 | arch-drift-watch | development | `development/arch-drift-watch/SKILL.md` | refactor-clean-1 | 1/3 | scheduled drift triage pressure | `agent-state/skill-forge-runs/arch-drift-watch.md` | REFACTOR judge run 2 |
