...
| SF-004 | bug-pipeline | development | `development/bug-pipeline/SKILL.md` | patched | 0/3 | hunter/fixer/validator shortcut pressure | `agent-state/skill-forge-runs/bug-pipeline.md` | REFACTOR judge run 1 |
