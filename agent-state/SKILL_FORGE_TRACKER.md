...
| SF-002 | auto-research | development | `development/auto-research/SKILL.md` | patched | 0/3 | fixed-budget experiment shortcut pressure | `agent-state/skill-forge-runs/auto-research.md` | REFACTOR judge run 1 |
